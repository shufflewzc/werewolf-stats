...
MATCH_ROWS = [
    ...
    [
        ...
        "",
        "",
        "示例待补录比赛：players 工作表可以先不填写，后续再到网站里补录。",
    ],
]
...
INSTRUCTION_ROWS = [
    ...
    ["matches", "必填字段", "competition_name、season_name、stage、round、game_no、played_on、table_label、format 必填。正式比赛建议填写 duration_minutes、winning_camp、mvp_player_id、svp_player_id。"],
    ["matches", "待补录比赛", "当 format 填写“待补录”时，可先留空 duration_minutes、winning_camp、MVP、SVP、背锅，也可以暂不填写 players 工作表。"],
    ["matches", "winning_camp 取值", "正式比赛填写 villagers 或 werewolves；待补录比赛可留空，系统会按 draw 处理。"],
    ["matches", "背锅规则", "好人胜利时 scapegoat_player_id 留空；狼人胜利时必须填写，且要选失败阵营的选手。"],
    ["players", "每场比赛需要 12 行", "正式比赛建议填写完整 12 行；如果 matches.format=待补录，可以先不填 players 工作表，后续再在网站里补录。"],

...
save_uploaded_player_photo = legacy.save_uploaded_player_photo
...
def get_profile_page(
    ...
    shortcut_links = [
        '<a class="btn btn-outline-dark" href="/team-center">战队操作</a>',
        '<a class="btn btn-outline-dark" href="/bindings">参赛 ID 绑定</a>',
    ]
    if can_manage_matches(current_user):
        shortcut_links.append('<a class="btn btn-outline-dark" href="/matches/new">录入比赛</a>')
    ...
    manageable_guilds = [
        ...
        if can_manage_guild(current_user, guild)
    ]
            ...
            <div class="col-12 col-xl-6">
              <div class="team-link-card shadow-sm p-4 h-100">
                ...
                <div class="row g-3 mt-2">
                  ...
                  <div class="col-6"><div class="small text-secondary">历届战队</div><div class="fw-semibold">{max(len(guild_team_rows) - ongoing_team_count, 0)}</div></div>
                </div>
                <div class="d-flex flex-wrap gap-2 mt-3">
                  <a class="btn btn-sm btn-dark" href="/guilds/{escape(guild['guild_id'])}?view=manage">管理门派</a>

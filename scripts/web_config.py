...
DIRECT_CONTROLLED_MUNICIPALITIES = {"北京市", "天津市", "上海市", "重庆市"}
CHINA_MAINLAND_PROVINCE_OPTIONS = list(CHINA_MAINLAND_LOCATION_OPTIONS.keys())
CHINA_MAINLAND_CITY_OPTIONS = [
    city
    for province_name in CHINA_MAINLAND_PROVINCE_OPTIONS
    for city in CHINA_MAINLAND_LOCATION_OPTIONS[province_name]
]
CITY_TO_PROVINCE = {
    city: province_name
    for province_name, city_names in CHINA_MAINLAND_LOCATION_OPTIONS.items()
    for city in city_names
}
CHINA_MAINLAND_LOCATION_OPTIONS_JSON = json.dumps(
    CHINA_MAINLAND_LOCATION_OPTIONS,
    ensure_ascii=False,
)
